...
<body>
<?php
          if (isset($_SESSION['add_product']) && !empty($_SESSION['add_product'])) {
            echo $_SESSION['add_product'];
            unset($_SESSION['add_product']);
        }

        if (isset($_SESSION['update_product']) && !empty($_SESSION['update_product'])) {
            echo $_SESSION['update_product'];
            unset($_SESSION['update_product']);
        }
        if (isset($_SESSION['delete_product']) && !empty($_SESSION['delete_product'])) {
        ...
        <div class="intro">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a href="deleteProduct.php?id=<?php echo $product->pID; ?>"onclick="return confirm('Are you sure you want to delete this Product?');"><span class="material-symbols-outlined">delete</span></a>
                        <a href="EditProducts.php?id=<?php echo $product->pID; ?>"><span class="material-symbols-outlined">edit</span></a>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php else: ?>
